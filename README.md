...
```
┌──────────────────────────────────────────────┐
│ write the release notes        1:23:45  +  ≡ │
└──────────────────────────────────────────────┘
  task name (4 cm)               clock    │  └── menu
                                          └───── new task / finish
```
...
**Switch back.** Open the menu with `≡` and pick a task under _switch to_. It moves to the
...
**Take a break.** Pick `pause` from the menu. It is a permanent task that can never be
...
typed in. Press _Close day_ to stamp the day as finished; open tasks stay on the stack for
tomorrow.
...
**Move the bar.** Drag it anywhere that is not a button. The position is remembered.
